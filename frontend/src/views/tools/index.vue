...
import TabCheckinManager from './TabCheckinManager.vue'
...
<template>
  <div class="settings-container">
    ...
    <div class="settings-content">
      <a-tabs v-model:active-key="activeKey" type="card" :loading="toolsLoading" class="settings-tabs">
        <a-tab-pane key="arknightspc">
          <template #tab>
            <span style="display: flex; align-items: center; gap: 8px">
              <span>明日方舟PC端</span>
              <a-tag v-if="arknightsPCStatusTag" :color="arknightsPCStatusTag.color" style="margin: 0; font-size: 12px">
